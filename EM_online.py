...
class GaussianMixture:
    ...
    def fit(self, X, label):
        ...
        print(self.pi)
        print("Answer:", pi_ans)
        self_pi_sort, _ = torch.sort(self.pi)
        pi_ans_sort, _ = torch.sort(pi_ans)
        print(self_pi_sort - pi_ans_sort)
    ...
    def _expect(self, X, label):
        ...
        # det_sigma = torch.linalg.det(sigma.to(torch.float64)).abs()
        ...
        # print(distance[0])
        # print(torch.exp(distance).to(torch.float64))

        # p_x_given_t = (torch.exp(distance).to(torch.float64) /
        #                torch.sqrt(det_sigma))
        ...
        # print(torch.exp(q_unnormalized - q_unnormalized_sum))
